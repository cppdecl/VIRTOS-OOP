#ifndef NEARGYE_Enum_HPP
#define NEARGYE_Enum_HPP

#define Enum_VERSION_MAJOR 0
#define Enum_VERSION_MINOR 8
#define Enum_VERSION_PATCH 2
...
#if defined(Enum_CONFIG_FILE)
#include Enum_CONFIG_FILE
#endif

#if !defined(Enum_USING_ALIAS_OPTIONAL)
#include <optional>
#endif
#if !defined(Enum_USING_ALIAS_STRING)
#include <string>
#endif
#if !defined(Enum_USING_ALIAS_STRING_VIEW)
#include <string_view>
#endif
#if !defined(Enum_NO_STREAMS)
#include <iosfwd>
#endif
...
// Checks Enum compiler compatibility.
...
#define Enum_SUPPORTED 1
#endif

// Checks Enum compiler aliases compatibility.
#if defined(__clang__) && __clang_major__ >= 5 || defined(__GNUC__) && __GNUC__ >= 9 || \
	defined(_MSC_VER) && _MSC_VER >= 1920
#undef Enum_SUPPORTED_ALIASES
#define Enum_SUPPORTED_ALIASES 1
#endif

// Enum value must be greater or equals than Enum_RANGE_MIN. By default Enum_RANGE_MIN = -128.
// If need another min range for all enum types by default, redefine the macro Enum_RANGE_MIN.
#if !defined(Enum_RANGE_MIN)
#define Enum_RANGE_MIN -128
#endif

// Enum value must be less or equals than Enum_RANGE_MAX. By default Enum_RANGE_MAX = 128.
// If need another max range for all enum types by default, redefine the macro Enum_RANGE_MAX.
...
#undef Enum_GET_ENUM_NAME_BUILTIN
#undef Enum_GET_TYPE_NAME_BUILTIN
#if __RESHARPER__ >= 20230100
#define Enum_GET_ENUM_NAME_BUILTIN(V) __rscpp_enumerator_name(V)
#define Enum_GET_TYPE_NAME_BUILTIN(T) __rscpp_type_name<T>()
#else
#define Enum_GET_ENUM_NAME_BUILTIN(V) nullptr
#define Enum_GET_TYPE_NAME_BUILTIN(T) nullptr
#endif
#endif

namespace Enum
{
// If need another optional type, define the macro Enum_USING_ALIAS_OPTIONAL.
#if defined(Enum_USING_ALIAS_OPTIONAL)
Enum_USING_ALIAS_OPTIONAL
#else
using std::optional;
#endif

// If need another string_view type, define the macro Enum_USING_ALIAS_STRING_VIEW.
#if defined(Enum_USING_ALIAS_STRING_VIEW)
	Enum_USING_ALIAS_STRING_VIEW
#else
using std::string_view;
#endif

// If need another string type, define the macro Enum_USING_ALIAS_STRING.
#if defined(Enum_USING_ALIAS_STRING)
		Enum_USING_ALIAS_STRING
#else
using std::string;
#endif
	...
	namespace customize
{
	// Enum value must be in range [Enum_RANGE_MIN, Enum_RANGE_MAX]. By default Enum_RANGE_MIN = -128,
	// Enum_RANGE_MAX = 128. If need another range for all enum types by default, redefine the macro
	// Enum_RANGE_MIN and Enum_RANGE_MAX. If need another range for specific enum type, add specialization
	// enum_range for necessary enum type.
	template <typename E>
	struct enum_range
	{
		static_assert(std::is_enum_v<E>, "Enum::customize::enum_range requires enum type.");
		static constexpr int min = Enum_RANGE_MIN;
		static constexpr int max = Enum_RANGE_MAX;
		static_assert(max > min, "Enum::customize::enum_range requires max > min.");
	};

	static_assert(Enum_RANGE_MAX > Enum_RANGE_MIN, "Enum_RANGE_MAX must be greater than Enum_RANGE_MIN.");
	static_assert((Enum_RANGE_MAX - Enum_RANGE_MIN) < (std::numeric_limits<std::uint16_t>::max)(),
				  "Enum_RANGE must be less than UINT16_MAX.");
	...
	// If need custom names for enum, add specialization GetName for necessary enum type.
	template <typename E>
	constexpr customize_t GetName(E) noexcept
	{
		return default_tag;
	}
...
template <typename T>
struct supported
#if defined(Enum_SUPPORTED) && Enum_SUPPORTED || defined(Enum_NO_CHECK_SUPPORT)
	: std::true_type
{
};
#else
...
#if defined(Enum_ENABLE_NONASCII)
			  (c & 0x80) ||
#endif
			  (c == '_')))
		{
...
class case_insensitive
{
   ...
   public:
	...
	{
#if defined(Enum_ENABLE_NONASCII)
		static_assert(always_false_v<L, R>, "Enum::case_insensitive not supported Non-ASCII feature.");
		return false;
#else
...
{
	static_assert(std::is_integral_v<L> && std::is_integral_v<R>, "Enum::detail::cmp_less requires integral type.");
...
{
	static_assert(std::is_integral_v<I>, "Enum::detail::log2 requires integral type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::n requires enum type.");

	if constexpr (supported<E>::value)
	{
#if defined(Enum_GET_TYPE_NAME_BUILTIN)
		constexpr auto name_ptr = Enum_GET_TYPE_NAME_BUILTIN(E);
...
{
	static_assert(is_enum_v<E>, "Enum::detail::type_name requires enum type.");
	...
	static_assert(std::is_same_v<std::decay_t<decltype(custom)>, customize::customize_t>,
				  "Enum::customize requires customize_t type.");
	if constexpr (custom.first == customize::detail::customize_tag::custom_tag)
	{
		constexpr auto name = custom.second;
		static_assert(!name.empty(), "Enum::customize requires not empty string.");
	...
	{
		static_assert(detail::always_false_v<E>, "Enum::customize invalid.");
	}
}
...
constexpr auto n() noexcept
{
	...
	if constexpr (supported<E>::value)
	{
#if defined(Enum_GET_ENUM_NAME_BUILTIN)
		constexpr auto name_ptr = Enum_GET_ENUM_NAME_BUILTIN(V);
		constexpr auto name		= name_ptr ? string_view{name_ptr} : std::string_view{};
#elif defined(__clang__) || defined(__GNUC__)
		constexpr auto name = pretty_name({__PRETTY_FUNCTION__, sizeof(__PRETTY_FUNCTION__) - 2});
#elif defined(_MSC_VER)
...
{
	static_assert(is_enum_v<E>, "Enum::detail::GetName requires enum type.");

	[[maybe_unused]] constexpr auto custom = customize::GetName<E>(V);
	static_assert(std::is_same_v<std::decay_t<decltype(custom)>, customize::customize_t>,
				  "Enum::customize requires customize_t type.");
	if constexpr (custom.first == customize::detail::customize_tag::custom_tag)
	{
...
template <typename E, E V>
inline constexpr auto GetName_v = GetName<E, V>();

template <typename E, auto V>
constexpr bool is_valid() noexcept
{
	static_assert(is_enum_v<E>, "Enum::detail::is_valid requires enum type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::ualue requires enum type.");

	if constexpr (std::is_same_v<U, bool>)
	{  // bool special case
		static_assert(O == 0, "Enum::detail::ualue requires valid offset.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::value requires enum type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::reflected_min requires enum type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::reflected_max requires enum type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::values requires enum type.");
...
constexpr auto values() noexcept
{
	...
	static_assert(range_size > 0, "Enum::enum_range requires valid size.");
	static_assert(range_size < (std::numeric_limits<std::uint16_t>::max)(), "Enum::enum_range requires valid size.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::is_flags_enum requires enum type.");
	...
	{
#if defined(Enum_NO_CHECK_FLAGS)
		return false;
#else
...
{
	static_assert(is_enum_v<E>, "Enum::detail::names requires enum type.");

	return std::array<string_view, sizeof...(I)>{{GetName_v<E, values_v<E>[I]>...}};
}
...
{
	static_assert(is_enum_v<E>, "Enum::detail::entries requires enum type.");

	return std::array<std::pair<E, string_view>, sizeof...(I)>{{{values_v<E>[I], GetName_v<E, values_v<E>[I]>}...}};
}
...
{
	static_assert(is_enum_v<E>, "Enum::detail::is_sparse requires enum type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::values_ors requires enum type.");
...
struct enable_if_enum<true, R>
{
	...
	static_assert(supported<R>::value,
				  "Enum unsupported compiler (https://github.com/Neargye/Enum#compiler-compatibility).");
};
...
template <typename T, typename R, value_type VT, typename BinaryPredicate = std::equal_to<>,
...
#define Enum_FOR_EACH_256(T)                                                                                           \
	T(0)                                                                                                               \
	T(1)                                                                                                               \
	T(2)                                                                                                               \
	T(3)                                                                                                               \
	T(4) T(5) T(6) T(7) T(8) T(9) T(10) T(11) T(12) T(13) T(14) T(15) T(16) T(17) T(18) T(19) T(20) T(21) T(22) T(23)  \
		T(24) T(25) T(26) T(27) T(28) T(29) T(30) T(31) T(32) T(33) T(34) T(35) T(36) T(37) T(38) T(39) T(40) T(41)    \
			T(42) T(43) T(44) T(45) T(46) T(47) T(48) T(49) T(50) T(51) T(52) T(53) T(54) T(55) T(56) T(57) T(58)      \
						...
						T(107) T(108) T(109) T(110) T(111) T(112) T(113) T(114) T(115) T(116) T(117) T(118) T(119)     \
							T(120) T(121) T(122) T(123) T(124) T(125) T(126) T(127) T(128) T(129) T(130) T(131) T(132) \
								T(133) T(134) T(135) T(136) T(137) T(138) T(139) T(140) T(141) T(142) T(143) T(144)    \
									T(145) T(146) T(147) T(148) T(149) T(150) T(151) T(152) T(153) T(154) T(155)       \
										T(156) T(157) T(158) T(159) T(160) T(161) T(162) T(163) T(164) T(165) T(166)   \
											T(167) T(168) T(169) T(170) T(171) T(172) T(173) T(174) T(175) T(176)      \
												T(177) T(178) T(179) T(180) T(181) T(182) T(183) T(184) T(185) T(186)  \
													T(187) T(188) T(189) T(190) T(191) T(192) T(193) T(194) T(195)     \
														T(196) T(197) T(198) T(199) T(200) T(201) T(202) T(203) T(204) \
															T(205) T(206) T(207) T(208) T(209) T(210) T(211) T(212)    \
																T(213) T(214) T(215) T(216) T(217) T(218) T(219)       \
																	T(220) T(221) T(222) T(223) T(224) T(225) T(226)   \
																		T(227) T(228) T(229) T(230) T(231) T(232)      \
																			T(233) T(234) T(235) T(236) T(237) T(238)  \
																				T(239) T(240) T(241) T(242) T(243)     \
																					T(244) T(245) T(246) T(247) T(248) \
	...
	case cases[val]:                                                                                             \
		...
		{                                                                                                        \
			...
			{                                                                                                    \
				...
				{                                                                                                \
					assert(false && "Enum::detail::constexpr_switch wrong result type.");                        \
				}                                                                                                \
			}                                                                                                    \
										  ...
										  ResultGetterType&& def, BinaryPredicate&& pred = {})
{
	...
	static_assert(has_duplicate<GlobValues, hash_t>(),
				  "Enum::detail::constexpr_switch duplicated hash found, please report it: "
				  "https://github.com/Neargye/Enum/issues.");
	constexpr std::array  values = *GlobValues;
	constexpr std::size_t size	 = values.size();
	...
	{
		Enum_FOR_EACH_256(Enum_CASE) default : if constexpr (size > 256 + Page)
		{
...
{
	static_assert(is_enum_v<E>, "Enum::detail::for_each requires enum type.");
...
{
	static_assert(is_enum_v<E>, "Enum::detail::all_invocable requires enum type.");
...
// Checks is Enum supported compiler.
inline constexpr bool is_Enum_supported = detail::supported<void>::value;
...
[[nodiscard]] constexpr auto enum_type_name() noexcept -> detail::enable_if_t<E, string_view>
{
	...
	static_assert(!name.empty(), "Enum::enum_type_name enum type does not have a name.");
...
{
	using D = std::decay_t<E>;
	static_assert(I < detail::count_v<D>, "Enum::enum_value out of range.");
...
template <typename E>
[[nodiscard]] constexpr auto enum_index([[maybe_unused]] E value) noexcept
...
[[nodiscard]] constexpr auto enum_index() noexcept -> detail::enable_if_t<decltype(V), std::size_t>
{
	...
	static_assert(index, "Enum::enum_index enum value does not have a index.");
...
template <auto V>
[[nodiscard]] constexpr auto GetName() noexcept -> detail::enable_if_t<decltype(V), string_view>
{
	constexpr string_view name = detail::GetName_v<std::decay_t<decltype(V)>, V>;
	static_assert(!name.empty(), "Enum::GetName enum value does not have a name.");
...
[[nodiscard]] constexpr auto GetName(E value) noexcept -> detail::enable_if_default_t<E, string_view, VT>
{
	using D = std::decay_t<E>;
...
[[nodiscard]] constexpr auto GetName(E value) -> detail::enable_if_default_t<E, string_view, VT>
{
	using D = std::decay_t<E>;

	return GetName<D, VT>(value);
}

// Returns name from enum value.
// If enum value does not have name or value out of range, returns empty string.
template <typename E, detail::value_type VT>
[[nodiscard]] auto GetName(E value) -> detail::enable_if_flags_t<E, string, VT>
{
	using D = std::decay_t<E>;
	using U = underlying_type_t<D>;
	static_assert(detail::is_flags_v<D>, "Enum::enum_flags_name requires enum-flags type.");
...
[[nodiscard]] auto enum_flags_name(E value, [[maybe_unused]] char sep = '|') -> detail::enable_if_t<E, string>
{
	...
	return GetName<D, detail::value_type::flags_value>(value);
}

// Returns std::array with names, sorted by enum value.
template <typename E>
[[nodiscard]] constexpr auto GetNames() noexcept -> detail::enable_if_t<E, detail::names_t<E>>
{
...
// Allows you to write Enum::enum_cast<foo>("bar", Enum::case_insensitive);
...
{
	using D = std::decay_t<E>;
	static_assert(detail::is_flags_v<D>, "Enum::enum_flags_cast requires enum-flags type.");
...
{
	using D = std::decay_t<E>;
	static_assert(detail::is_flags_v<D>, "Enum::enum_flags_contains requires enum-flags type.");
...
{
	using D = std::decay_t<E>;
	static_assert(std::is_enum_v<D>, "Enum::enum_for_each requires enum type.");
	...
	{
		static_assert(detail::always_false_v<D>, "Enum::enum_for_each requires invocable of all enum value.");
	}
}
...
std::basic_ostream<Char, Traits>& operator<<(std::basic_ostream<Char, Traits>& os, E value)
{
	...
	{
		if (const auto name = GetName<D, as_flags<detail::is_flags_v<D>>>(value); !name.empty())
		{
